...
@admin.register(ProfileVor2_bot3)
class AdminProfile(admin.ModelAdmin):
    list_display = ["id", "name"]
    list_display_links = ("id", "name")
    ordering = ("-id",)
    form = FormProfileVor2_bot4

@admin.register(MassageVor2_bot3)
...
@admin.register(ProfileVor3_bot3)
class AdminProfile(admin.ModelAdmin):
    list_display = ["id", "name"]
    list_display_links = ("id", "name")
    ordering = ("-id",)
    form = FormProfileVor3_bot4

@admin.register(MassageVor3_bot3)
...
@admin.register(ProfileVor4_bot3)
class AdminProfile(admin.ModelAdmin):
    list_display = ["id", "name"]
    list_display_links = ("id", "name")
    ordering = ("-id",)
...
@admin.register(MassageVor4_bot3)
...
@admin.register(ProfileVor5_bot3)
class AdminProfile(admin.ModelAdmin):
    list_display = ["id", "name"]
    list_display_links = ("id", "name")
    ordering = ("-id",)
...
@admin.register(MassageVor5_bot3)
