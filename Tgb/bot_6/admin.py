...
@admin.register(Profile_bot6)
class AdminProfile(admin.ModelAdmin):
    list_display = ["id", "name", "data"]
    list_display_links = ("id", "name")
    ordering = ("-id",)
    form = FormProfile_bot6


@admin.register(Massage_bot6)
...
@admin.register(ProfileVor2_bot6)
class AdminProfile(admin.ModelAdmin):
...
@admin.register(MassageVor2_bot6)
...
@admin.register(ProfileVor3_bot6)
class AdminProfile(admin.ModelAdmin):
    list_display = ["id", "name"]
    list_display_links = ("id", "name")
    ordering = ("-id",)
...
@admin.register(MassageVor3_bot6)
...
@admin.register(ProfileVor4_bot6)
class AdminProfile(admin.ModelAdmin):
    list_display = ["id", "name"]
    list_display_links = ("id", "name")
    ordering = ("-id",)
...
@admin.register(MassageVor4_bot6)
...
@admin.register(ProfileVor5_bot6)
class AdminProfile(admin.ModelAdmin):
    list_display = ["id", "name"]
    list_display_links = ("id", "name")
    ordering = ("-id",)
...
@admin.register(MassageVor5_bot6)
