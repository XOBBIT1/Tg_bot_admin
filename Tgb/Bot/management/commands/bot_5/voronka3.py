from bot_5.models import ProfileVor3_bot5, MassageVor3_bot5
...
def Vor3_mes2(update: Update, context: CallbackContext):
    ...
    p, _ = ProfileVor3_bot5.objects.get_or_create(
        id=chat_id,
        defaults={
    ...
    try:
        mes1 = MassageVor3_bot5.objects.get(id=1)
        message1 = f"{mes1}"
...
def Vor3_mes3(update: Update, context: CallbackContext):
    try:
        mes1 = MassageVor3_bot5.objects.get(id=2)
        message1 = f"{mes1}"
        update.message.reply_text(message1)
...
def Vor3_mes4(update: Update, context: CallbackContext):
    try:
        mes1 = MassageVor3_bot5.objects.get(id=3)
        message1 = f"{mes1}"
        update.message.reply_text(message1)
...
def Vor3_mes5(update: Update, context: CallbackContext):
    try:
        mes1 = MassageVor3_bot5.objects.get(id=4)
        message1 = f"{mes1}"
        update.message.reply_text(message1)
...
def Vor3_mes6(update: Update, context: CallbackContext):
    try:
        mes1 = MassageVor3_bot5.objects.get(id=5)
        message1 = f"{mes1}"
        update.message.reply_text(message1)
...
def Vor3_mes7(update: Update, context: CallbackContext):
    try:
        mes1 = MassageVor3_bot5.objects.get(id=6)
        message1 = f"{mes1}"
        update.message.reply_text(message1)
...
def Vor3_mes8(update: Update, context: CallbackContext):
    try:
        mes1 = MassageVor3_bot5.objects.get(id=7)
        message1 = f"{mes1}"
        update.message.reply_text(message1)
...
def Vor3_mes9(update: Update, context: CallbackContext):
    try:
        mes1 = MassageVor3_bot5.objects.get(id=8)
        message1 = f"{mes1}"
        update.message.reply_text(message1)
...
def Vor3_mes10(update: Update, context: CallbackContext):
    try:
        mes1 = MassageVor3_bot5.objects.get(id=9)
        message1 = f"{mes1}"
        update.message.reply_text(message1)
