from bot_2.models import Profile_bot2, Massage_bot2
...
def start(update: Update, context: CallbackContext):
    ...
    p, _ = Profile_bot2.objects.get_or_create(
        id=chat_id,
        defaults={
    ...
    try:
        mes1 = Massage_bot2.objects.all().first()
        name = update.message.from_user.first_name
...
def mes2(update: Update, context: CallbackContext):
    try:
        mes1 = Massage_bot2.objects.get(id=2)
        message1 = f"{mes1}"
        update.message.reply_text(message1)
...
def mes3(update: Update, context: CallbackContext):
    try:
        mes1 = Massage_bot2.objects.get(id=3)
        message1 = f"{mes1}"
        update.message.reply_text(message1)
...
def mes4(update: Update, context: CallbackContext):
    try:
        mes1 = Massage_bot2.objects.get(id=4)
        message1 = f"{mes1}"
        update.message.reply_text(message1)
...
def mes6(update: Update, context: CallbackContext):
    try:
        mes1 = Massage_bot2.objects.get(id=6)
        message1 = f"{mes1}"
        update.message.reply_text(message1)
...
def mes7(update: Update, context: CallbackContext):
    try:
        mes1 = Massage_bot2.objects.get(id=7)
        message1 = f"{mes1}"
        update.message.reply_text(message1)
...
def mes8(update: Update, context: CallbackContext):
    try:
        mes1 = Massage_bot2.objects.get(id=8)
        message1 = f"{mes1}"
        update.message.reply_text(message1)
...
def mes9(update: Update, context: CallbackContext):
    try:
        mes1 = Massage_bot2.objects.get(id=9)
        message1 = f"{mes1}"
        update.message.reply_text(message1)
...
def mes10(update: Update, context: CallbackContext):
    try:
        mes1 = Massage_bot2.objects.get(id=10)
        message1 = f"{mes1}"
        update.message.reply_text(message1)
